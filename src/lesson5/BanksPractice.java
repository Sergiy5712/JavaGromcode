...
public class BanksPractice {
    ...
    static void depositMoney(String[] clients, int[] balances, String client, int money) {
       ...
       /* int clientIndex = 0;
        ...
        int moneyToDeposit = calculatedDepositAmountAfterComission(money);
        //3
        //balances[clientIndex] += moneyToDeposit;
        balances[findClientIndexByName(clients, client)] += calculatedDepositAmountAfterComission(money);
    ...
    static int calculatedDepositAmountAfterComission(int money){
